...
?>
                ...
                <div class="side">
                    ...
                    <div class="side-wrap">
                       ...
                       <div class="item-wrap">
                            <?$APPLICATION->IncludeComponent("bitrix:news.list", "rew_left", Array(
        ...
        <div class="inner-wrap">
            <nav class="main-menu">
                <div class="item">
                    ...
                    <?$APPLICATION->IncludeComponent("bitrix:menu", "bottom_exam", Array(
            ...
            <div class="contacts-block">
                ...
                <div class="loc-block">
                    ...
                    <div class="phone"><a href="tel:<?echo file_get_contents('footer_phone.php');?>"> 
                    <?$APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        "",
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/exam1/include/footer_phone.php"
                        )
                    );?><br>
                    </a>
                    </div>
